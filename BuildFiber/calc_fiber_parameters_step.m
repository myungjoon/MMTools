...
modes_used = [1:30]; % an array; in general the modes do not have to be consecutive
...
num_disp_orders = 3; % i.e. if this is 3, four coefficients will be calculated, including the 0th order
